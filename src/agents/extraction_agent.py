...
def extract_contract_changes(original: str, amended: str, context: str) -> dict:
    ...
    user_prompt = (
        ...
        "6. **Formato de Salida**: Genera un JSON con esta estructura exacta (IMPORTANTE: 'summary_of_the_change' debe ser un OBJETO con LISTAS de hallazgos):\n"
        "{\n"
        ...
        "    \"modifications\": [\"Hallazgo 1 en cláusula X...\", \"Hallazgo 2 en cláusula Y...\"],\n"
        "    \"additions\": [\"Nueva cláusula incorporada...\", \"Nuevo párrafo en sección Z...\"],\n"
        "    \"deletions\": [\"Cláusula X eliminada por completo...\", \"Párrafo sobre Y removido...\"]\n"
        "  }\n"
        "}"
    )
